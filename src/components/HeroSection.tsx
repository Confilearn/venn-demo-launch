      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="flex-1 text-center lg:text-left animate-fade-up">
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-lg mx-auto lg:mx-0">
            A demo product by <a href="https://venn.ca" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">venn.ca</a>. 
        ...
        {/* Phone mockup */}
        <div className="flex-1 flex justify-center animate-float" style={{ animationDelay: "0.3s" }}>
          <img
            src={heroPhone}
